                ...
                <View style={styles.dropdownContainerWithAdd}>
                    <View style={{ flex: 1 }}>
                        ...
                        <CustomPicker
                            ...
                            // Apply base input style, CustomPicker handles its internal text color & placeholder
                            style={[styles.input, { paddingVertical: 10 }]} // Adjust padding if needed, default is 10
                            value={patientId}
